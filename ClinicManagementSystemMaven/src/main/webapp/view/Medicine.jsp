<%-- 
    Document   : Medicine
    Created on : Jun 17, 2025, 9:09:37 AM
    Author     : admin
--%>
...
<html lang="en" class="theme-fs-sm" data-bs-theme="light" data-bs-theme-color="default" dir="ltr">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Heebo:wght@300;400;500;600;700&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,300;1,400;1,500&display=swap" rel="stylesheet">    </head>
    <body class="  ">
        <!-- loader Start -->
        <div id="loading">
                        ...
                        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page"
                                    ...
                                    <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Patient" data-bs-placement="right">P</i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page"
                                    href="./products.html">
                                    <i class="icon" data-bs-toggle="tooltip" title="Products" data-bs-placement="right">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="nav-item">
                                <a class="nav-link " aria-current="page"
                                    href="./payment.html">
                                    <i class="icon" data-bs-toggle="tooltip" title="Payment" data-bs-placement="right">
                                        <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="nav-item static-item">
                                <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                                    <span class="default-icon">Special Pages</span>
                                    <span class="mini-icon" data-bs-toggle="tooltip" title="Elements" data-bs-placement="right">-</span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="collapse" href="#auth-skins" role="button" aria-expanded="false">
                                ...
                                <ul class="sub-nav collapse" id="auth-skins" data-bs-parent="#sidebar-menu">
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sign In" data-bs-placement="right"> SI
                                            </i>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sign Up" data-bs-placement="right"> S
                                            </i>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Email" data-bs-placement="right"> E
                                            </i>
                                            <span class="item-name">Email Verified</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link "
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Lock Screen" data-bs-placement="right">
                                                LS </i>
                                ...
                                <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link " href="./app/user-add.html">
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="User Add" data-bs-placement="right"> A </i>
                                ...
                                <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Maintenance" data-bs-placement="right"> M
                                            </i>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Error 404" data-bs-placement="right"> 404
                                            </i>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link "
                                            ...
                                            <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Error 500" data-bs-placement="right"> 500
                                            </i>
                                            <span class="item-name">500</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                                      ...
                                      <div class="nav-list-icon">
                                         <div class="btn-inner">
                                            <svg class="icon-20" width="19" height="22" viewBox="0 0 19 22" fill="none"
                                               xmlns="http://www.w3.org/2000/svg">
                                               <mask style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="19"
                                                  height="18">
                                                  <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <li class="nav-item iq-full-screen d-none d-xl-block" id="fullscreen-item">
                                   <a href="#" class="nav-link" id="btnFullscreen" data-bs-toggle="dropdown">
                                      <div class="icon nav-list-icon">
                                         <span class="btn-inner">
                                            <svg class="normal-screen icon-20" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                               xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <svg class="full-normal-screen d-none icon-20" width="24" height="24" viewBox="0 0 24 24"
                                   ...
                                   <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                                      ...
                                      <div class="icon-40">
                                         <span class="btn-inner d-inline-block position-relative">
                                            <img src="./assets/images/avatars/14.png"
...
<div class="d-flex align-items-center mb-4 mb-4 pb-3 pt-3">
    ...
    <span class="head-title fw-500 mt-1">Products</span>
</div><div class="card">
   <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
      ...
      <button class="btn btn-primary " type="button" data-bs-toggle="offcanvas"
         data-bs-target="#offcanvasProductAdd" aria-controls="offcanvasProductAdd">
         <span class="btn-inner">
            <span class="text d-inline-block align-middle">Add Product</span>
         ...
         <table class="table border-end border-start align-middle mb-0 rounded">
            ...
            <tbody>
               <tr data-item="list">
                  ...
                  <td>#14356</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Asthma Inhaler</h6>
                  </td>
                  <td>Health Care</td>
                  <td>$67.90</td>
                  <td>23</td>
                  ...
                  <td>173 Sold</td>
                  <td>
                     <a class="d-inline-block pe-2" data-bs-toggle="offcanvas" href="#offcanvasProductEdit" aria-controls="offcanvasProductEdit">
                        <span class="text-success">
                           <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path d="M9.31055 14.3321H14.75" stroke="currentColor" stroke-width="1.5"
                     ...
                     <a href="#" class="d-inline-block ps-2 delete-btn" >
                        <span class="text-danger">
                           <svg width="15" height="16" viewBox="0 0 15 16" fill="none"
                              ...
                              <path
                                 ...
                                 stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                 stroke-linejoin="round" />
                              <path d="M13.5312 3.67969H0.812744" stroke="currentColor" stroke-width="1.5"
                                 stroke-linecap="round" stroke-linejoin="round" />
                              <path
               ...
               <tr data-item="list">
                  ...
                  <td>#14678</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Contact Lenses</h6>
                  </td>
               ...
               <tr data-item="list">
                  ...
                  <td>#12431</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Dental Equipment</h6>
                  </td>
                  <td>Medical Equipment</td>
                  <td>$280</td>
                  <td>12</td>
               ...
               <tr data-item="list">
                  ...
                  <td>#21356</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Electric Toothbrush</h6>
                  </td>
               ...
               <tr data-item="list">
                  ...
                  <td>#65783</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Hand Sanitizer</h6>
                  </td>
                  <td>Physical</td>
                  <td>$460</td>
                  <td>18</td>
               ...
               <tr data-item="list">
                  ...
                  <td>#12567</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Glucose Meter Set</h6>
                  </td>
                  <td>Medical Equipment</td>
                  <td>$220</td>
                  <td>18</td>
               ...
               <tr data-item="list">
                  ...
                  <td>#15342</td>
                  <td>
                     <h6 class="mb-0 text-body fw-normal">Handgloves</h6>
                  </td>
                  <td>Medical Equipment</td>
                  <td>$390</td>
                  <td>34</td>    
   ...
   <div class="card-footer pt-0">
      <div class="d-flex justify-content-between align-items-center gap-3 flex-wrap">
          <ul class="page-number m-0 p-0 list-unstyled d-flex gap-2">
              <li class="text-center bg-primary text-white rounded">1</li>
              <li class="text-center bg-primary-subtle text-primary rounded ">2</li>
              <li class="text-center text-primary rounded fs-1">...</li>
              <li class="text-center bg-primary-subtle text-primary rounded">6</li>
          </ul>
          <div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasProductEdit"
   aria-labelledby="offcanvasProductEditLabel">
   <div class="offcanvas-header border-bottom">
      <h3 class="offcanvas-title" id="offcanvasProductEditLabel">Edit Product</h3>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
   </div>
   <div class="offcanvas-body">
       <div class="form-group">
         <label class="form-label" for="Id">Product Id <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="Id" value="#14356">
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="Name">Product Name <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="Name" value="Asthma Inhaler">
      </div>
      <div class="form-group">
         <label class="form-label">Category <span class="text-danger">*</span></label>
         <select class="form-control select2-basic-single">
            <option>Medical Equipment</option>
            <option selected="selected">Health Care</option>
      ...
      <div class="form-group col-md-12">
         ...
         <input type="text" class="form-control" id="Price" value="$67.90">
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="stock">In Stock <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="stock" value="23">
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="discount">Discount <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="discount" value="15% Off">
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="sale">Sale <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="sale" value="173 Sold">
      </div>
   </div>
   <div class="offcanvas-footer border-top">
      <div class="d-grid d-md-flex gap-3 p-3">
         ...
         <button class="btn btn-secondary d-block" type="button" data-bs-dismiss="offcanvas">
            <span class="btn-inner">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasProductAdd"
   aria-labelledby="offcanvasProductAddLabel">
   <div class="offcanvas-header border-bottom">
      <h3 class="offcanvas-title" id="offcanvasProductAddLabel">Add Product</h3>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
   </div>
   <div class="offcanvas-body">
       <div class="form-group">
         <label class="form-label" for="add_Id">Product Id <span class="text-danger">*</span></label>
      ...
      <div class="form-group">
         <label class="form-label" for="add_category">Category <span class="text-danger">*</span></label>
         <select class="form-control select2-basic-single" id="add_category">
            <option>Medical Equipment</option>
      ...
      <div class="form-group col-md-12">
         <label class="form-label" for="add_Price">Price <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="add_Price" >
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="add_stock">In Stock <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="add_stock">
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="add_discount">Discount <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="add_discount" >
      </div>
      <div class="form-group col-md-12">
         <label class="form-label" for="add_sale">Sale <span class="text-danger">*</span></label>
         <input type="text" class="form-control" id="add_sale" >
      </div>
   </div>
   <div class="offcanvas-footer border-top">
      <div class="d-grid d-md-flex gap-3 p-3">
         <button type="submit" class="btn btn-primary d-block">
            <span class="btn-inner">
               <span class="text d-inline-block align-middle">Save</span>
               <span class="icon d-inline-block align-middle ms-1 ps-2">
                     <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 8 8" fill="none">
                        <path
                           d="M7.32046 4.70834H4.74952V7.25698C4.74952 7.66734 4.41395 8 4 8C3.58605 8 3.25048 7.66734 3.25048 7.25698V4.70834H0.679545C0.293423 4.6687 0 4.34614 0 3.96132C0 3.5765 0.293423 3.25394 0.679545 3.21431H3.24242V0.673653C3.28241 0.290878 3.60778 0 3.99597 0C4.38416 0 4.70954 0.290878 4.74952 0.673653V3.21431H7.32046C7.70658 3.25394 8 3.5765 8 3.96132C8 4.34614 7.70658 4.6687 7.32046 4.70834Z"
            ...
            <footer class="footer">
                <div class="footer-body">
                    <ul class="left-panel list-inline mb-0 p-0">
                        <li class="list-inline-item fw-500"><a class="footer-link" href="./extra/privacy-policy.html">Privacy Policy</a></li>
                        <li class="list-inline-item fw-500"><a class="footer-link" href="./extra/terms-of-service.html">Terms of Use</a></li>
                    </ul>
                    <h6 class="right-panel mb-0">
                        © <script>document.write(new Date().getFullYear())</script> <span data-setting="app_name">KiviCare</span> with
                        <span class="text-danger">
        ...
        <div class="offcanvas offcanvas-end live-customizer" tabindex="-1" id="live-customizer" data-bs-scroll="true"
            ...
            <div class="offcanvas-header">
                <div class="d-flex align-items-center">
                    <h4 class="offcanvas-title" id="-label">Live Customizer</h4>
                </div>
                <div class="d-flex gap-2 align-items-center">
                    <button class="btn btn-primary p-2" data-copy="settings" data-bs-toggle="tooltip" data-bs-placement="left"
                        title="Copy">
                    ...
                    <button class="btn btn-primary p-2" data-reset="settings" data-bs-toggle="tooltip"
                ...
                <div class="me-xl-2">
                    <button type="button" class="btn-close p-0 text-reset shadow-none" data-bs-dismiss="offcanvas"
                                    ...
                                    <div class="collapse" id="custom-color">
                                        <div class="form-group d-flex justify-content-between align-items-center">
                                            ...
                                            <input name="theme_color" data-extra="primary" type="color"
                                                id="custom-primary-color" value="#7093e5" data-setting="color">
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                                        <div data-setting="radio" class="text-center">
                                            <input type="radio" value="sidebar-default navs-rounded" class="btn-check" name="sidebar_menu_style"
                                                id="navs-rounded">
                                        ...
                                        <div data-setting="radio" class="text-center">
                                            <input type="radio" value="text-hover" class="btn-check"
                                                name="sidebar_menu_style" id="text-hover" checked>
                                            <label class="btn btn-border position-relative p-0 d-block overflow-hidden" for="text-hover">
                                                <img src="./assets/images/settings/dark/14.png" alt="boxed"
                                                    class="mode dark-img img-fluid" width="200" height="200" loading="lazy">
                                                <img src="./assets/images/settings/light/14.png" alt="boxed"
                                                    class="mode light-img img-fluid" width="200" height="200" loading="lazy">
                                            </label>
                                            <span class="mt-2">Text Color</span>
                                        </div>
                                        <div data-setting="radio" class="text-center">
        ...
        <!-- Widgetchart Script -->
        <script src="./assets/js/charts/widgetcharts.js?v=1.4.1" defer></script>
        <!-- Dashboard Script -->
        <script src="./assets/js/charts/dashboard.js?v=1.4.1" defer></script>
        <!-- Hopeui Script -->
        <script src="./assets/js/kivicare.js?v=1.4.1" defer></script>
        <script src="./assets/js/kivicare-advance.js?v=1.4.1" defer></script>
        <script src="./assets/js/sidebar.js?v=1.4.1" defer></script>
        
        <!-- Icons -->
        <script src="./assets/js/solid-icon-search-filter.js?v=1.4.1" defer></script>
    </body>
</html>

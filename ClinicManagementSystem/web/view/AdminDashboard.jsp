...
<div class="d-flex align-items-center mb-4 mb-4 pb-3 pt-3">
    ...
    <span class="head-title fw-500 mt-1">Dashboard</span>
</div><div class="row">
    <div class="col-lg-8">
        <div class="d-flex align-items-center justify-content-between flex-sm-row flex-column-reverse">
            ...
            <div>
                <img class="img-fluid" src="./assets/images/dashboard/dr-dashboard.png" alt="dr-profile"
                    loading="lazy" />
            </div>
        </div>
        <div class="row mt-5">
            ...
            <div class="col-md-4">
                <div class="card card-block card-stretch card-height overflow-hidden">
                    ...
                    <div class="card-bg position-relative mt-2">
                        <img class="img-fluid float-end" src="./assets/images/dashboard/finance.png" alt="finance"
                            loading="lazy" />
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-block card-stretch card-height overflow-hidden">
                    ...
                    <div class="card-bg position-relative mt-2">
                        <img class="img-fluid float-end" src="./assets/images/dashboard/hand-holding-heart.png"
            ...
            <div class="card-body pt-0">
                <div class="d-flex align-items-center mb-4 bg-primary-subtle px-3 py-3 px-lg-4 rounded">
                    ...
                    <div class="border-start ps-3 ms-3 flex-grow-1">
                        <h5>Emily Johnson</h5>
                        <h6 class="mb-0">Reason: <span class="text-body fw-normal">Acne Treatment</span></h6>
                    </div>
                    <div>
                ...
                <div class="d-flex align-items-center mb-4 bg-primary-subtle px-3 py-3 px-lg-4 rounded">
                    ...
                    <div class="border-start ps-3 ms-3 flex-grow-1">
                        ...
                        <h6 class="mb-0">Reason: <span class="text-body fw-normal">Tooth Cleaning</span></h6>
                    </div>
                    <div>
                        <button class="dropdown btn border-0 p-0">
                            <svg width="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex align-items-center bg-primary-subtle px-3 py-3 px-lg-4 rounded">
                    ...
                    <div class="border-start ps-3 ms-3 flex-grow-1">
                        ...
                        <h6 class="mb-0">Reason: <span class="text-body fw-normal">Skin Whitening</span></h6>
                    </div>
                    <div>
                        <button class="dropdown btn border-0 p-0">
                            <svg width="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card-body pt-0">
                <ul class="list-inline m-0 p-0">
                    <li class="d-flex mb-4 align-items-center">
                        <div>
                            <img class="img-fluid" src="./assets/images/dashboard/draminelouis.png"
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        <div>
                            <img class="img-fluid" src="./assets/images/dashboard/drKeinoshine.png"
                                alt="Dr-profile" loading="lazy" />
                        </div>
                        <div class="ms-4 flex-grow-1">
                    ...
                    <li class="d-flex align-items-center">
                        <div>
                            <img class="img-fluid" src="./assets/images/dashboard/drMaxwellena.png"
                                alt="Dr-profile" loading="lazy" />
                        </div>
                        <div class="ms-4 flex-grow-1">
                ...
                <ul class="list-inline m-0 p-0">
                    <li
                        ...
                        <div class="d-flex gap-3 align-items-center flex-sm-row flex-column">
                            <img class="img-fluid" src="./assets/images/dashboard/angle-jonas.png"
                                alt="Dr-profile" loading="lazy" />
                            <div>
                                <h5>Angle Jonas </h5>
                        ...
                        <button class="badge bg-success-subtle text-success fw-500 px-3 py-2 border-0 me-sm-2 me-0">Paid</button>
                    </li>
                    <li
                        class="d-flex flex-wrap gap-sm-1 gap-3 align-items-center justify-content-between flex-sm-row flex-column text-sm-start text-center bg-primary-subtle p-3 mb-4 rounded">
                        <div class="d-flex gap-3 align-items-center flex-sm-row flex-column">
                            <img class="img-fluid" src="./assets/images/dashboard/alexa-zander.png"
                                alt="Dr-profile" loading="lazy" />
                            <div>
                                <h5>Alexa Zander</h5>
                        ...
                        <button class="badge bg-danger-subtle text-danger fw-500 px-3 py-2 border-0 me-sm-2 me-0">Accept</button>
                    </li>
                    <li
                    ...
                    <table class="table py-3 mb-0" role="grid" data-toggle="appointment_admin">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="./assets/images/table/10.png"
                                ...
                                <td>New Patient</td>
                                <td>
                                    <button class="badge bg-success-subtle text-success fw-500 px-3 py-2 border-0 me-2">Accept</button>
                                    <button class="badge bg-danger-subtle text-danger fw-500 px-3 py-2 border-0 me-2">Cancel</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="./assets/images/table/11.png"
                                            class="img-fluid flex-shrink-0 icon-40 object-fit-cover" alt="icon">
                            ...
                            <tr class="border-0">
                                ...
                                <td class="border-0">
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="./assets/images/table/12.png"
                                            class="img-fluid flex-shrink-0 icon-40 object-fit-cover" alt="icon">
...
//khi nao co servlet thi add vao lay danh sach doctor
<%
    // Assume this is set by a servlet before forwarding to the JSP
...
<div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
    <h4 class="mb-0">Available Doctors</h4>
    <div class="dropdown text-end">
        <button class="dropdown btn border-0 p-0" id="dropdownMenuAvailableDoc" data-bs-toggle="dropdown" aria-expanded="false">
            <span class="fw-500 d-inline-block align-middle">View All</span>
        ...
        <ul class="dropdown-menu dropdown-menu-soft-primary sub-dropdown" aria-labelledby="dropdownMenuAvailableDoc">
            <li><a class="dropdown-item active" href="#">View</a></li>
            <li><a class="dropdown-item" href="#">Appointment</a></li>
        </ul>
    </div>
...
<div class="card-body pt-0">
    <ul class="list-inline m-0 p-0">
        ...
        <li class="d-flex mb-4 align-items-center">
            <div>
                <img class="img-fluid" src="<%= doctor.getImageUrl() %>" alt="Dr-profile" loading="lazy" />
            </div>
            <div class="ms-4 flex-grow-1">
                <h5><%= doctor.getName() %></h5>
                <p class="mb-0"><%= doctor.getSpecialty() %></p>
            </div>
            <div>
                <h6 class="text-primary mb-0"><%= doctor.getPatientCount() %> patients</h6>
            </div>
        </li>
        <%
                }
        ...
        %>
        <li>No available doctors at the moment.</li>
        <%
            }
        %>
    </ul>
